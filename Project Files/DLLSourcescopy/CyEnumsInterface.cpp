...
void CyEnumsPythonInterface()
{
	...
	python::enum_<InterfaceModeTypes>("InterfaceModeTypes")
		...
		.value("INTERFACEMODE_BASIC_ROUTE_TO", INTERFACEMODE_BASIC_ROUTE_TO) // Ramstormp, WtP, Build basic 'Route to' first
	...
	python::enum_<MissionTypes>("MissionTypes")
		...
		.value("MISSION_BASIC_ROUTE_TO", MISSION_BASIC_ROUTE_TO) // Ramstormp, WtP, Build 'Basic Road To' Command
