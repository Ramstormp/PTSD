...
public:
	...
	RouteTypes getCheapestBuildRoute(CvPlot* pPlot, BuildTypes* peBestBuild = NULL) const; // Ramstormp, WtP, Cheaper Route To Command
	...
	bool groupBasicRoadTo(int iX, int iY, int iFlags); // Ramstormp, WtP, 'Basic Road To'
