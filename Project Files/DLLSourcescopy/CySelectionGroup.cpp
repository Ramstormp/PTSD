...
int /*RouteTypes*/ CySelectionGroup::getCheapestBuildRoute(CyPlot* pPlot, BuildTypes* peBestBuild)
{
	return m_pSelectionGroup ? m_pSelectionGroup->getCheapestBuildRoute(pPlot->getPlot(), peBestBuild) : -1;
}
// Ramstormp - END
