...
void CyEnumsPythonInterface()
{
	...
	python::enum_<WidgetTypes>("WidgetTypes")
		...
		.value("WIDGET_HELP_FOOD_STORAGE", WIDGET_HELP_POPULATION)
	...
	python::enum_<YieldTypes>("YieldTypes")
		...
		.value("YIELD_HEARTS", YIELD_HEARTS) // Ramstormp, PTSD, growth from food consumption
	...
	python::enum_<PlayerOptionTypes>("PlayerOptionTypes")
		...
		.value("PLAYEROPTION_AUTO_LEAVE_YIELDS", PLAYEROPTION_AUTO_LEAVE_YIELDS)
	...
	python::enum_<FontSymbols>("FontSymbols")
		...
		//.value("HEARTS_CHAR", HEARTS_CHAR) // Ramstormp, PTSD, Growth from food consumption
	...
	python::enum_<UnitTravelStates>("UnitTravelStates")
		...
		.value("UNIT_TRAVEL_STATE_FROM_AFRICA_TO_EUROPE", UNIT_TRAVEL_STATE_FROM_AFRICA_TO_EUROPE) // Ramstormp, PTSD, Give me a backward triangle
		// R&R, ray, Port Royal
