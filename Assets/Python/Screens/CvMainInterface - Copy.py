...
# <--- TAC
	...
	def updateScoreStrings( self ):
		...
		# Scrollable Scoreboard founded by Devolution expanded by Ramstormp
		screen.addTableControlGFC("ScoreBackground", 1, xResolution - 420, yResolution - 100 - 320, 410, 310, False, False, 0, 0, TableStyles.TABLE_STYLE_EMPTY)
		screen.enableSelect("ScoreBackground", False)
		screen.setTableColumnHeader("ScoreBackground", 0, "", 390)
