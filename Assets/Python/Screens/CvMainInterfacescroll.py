	...
	# CITY SCREEN UP
		if (CyInterface().isCityScreenUp()):
			...
			# POPULATION GROWTH/STARVATION TEXT
				...
				iProductionDiffJustFood = 0
				szBuffer = u"<font=4>"
				if (iFoodDifference < 0 and iFood < 20):
					szBuffer = localText.getText("INTERFACE_CITY_STARVING", ())
				elif (iHeartsDifference > 0):
...
# PTSD Food Storage
					...
					screen.setLabel("FoodStorageCapacityText", "Background", szFoodBuffer, CvUtil.FONT_CENTER_JUSTIFY, xResolution * 3 / 100 , CITY_TITLE_BAR_HEIGHT / 12, -0.3, FontTypes.SMALL_FONT, WidgetTypes.WIDGET_GENERAL, FOOD_CAPACITY, -1 )
...
# R&R, Robert Surcouf VET NewCapacity Help- Start
			...
			elif iData1 == FOOD_CAPACITY:
				return localText.getText("TXT_KEY_CITY_FOOD_STORAGE", ());
# R&R, Robert Surcouf VET NewCapacity Help- End
# CITY HAPPINESS vs UNHAPPINESS - START
