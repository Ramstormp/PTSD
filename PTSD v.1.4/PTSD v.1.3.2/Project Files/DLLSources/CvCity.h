...
// cache getMaxYieldCapacity - end - Nightinggale
	...
	// Ramstormp, PTSD, Give Abandoned city time to decay - START
	int getAbandonTimer() const;
	bool isAbandoned() const;
	void setAbandonTimer(int iNewValue);
	void changeAbandonTimer(int iChange);
	// Ramstormp - END
...
//VET NewCapacity - end 1/2
	...
	int getTotalDomesticDemands() const; // Ramstormp, PTSD, totally unnecessary function at the moment
...
protected:
	...
	int m_iAbandonTimer; // Ramstormp, PTSD, Give abandoned city time to decay
