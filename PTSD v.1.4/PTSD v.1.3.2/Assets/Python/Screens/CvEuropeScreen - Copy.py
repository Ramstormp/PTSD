...
class CvEuropeScreen:
	...
	def __init__(self):
		...
		#self.SAIL_TO_AFRICA = 37 #Ramstormp, PTSD, Triangle trade
...
#
	...
	def cargoMessage(self, iUnit):
		...
		#szText += self.travelMessage(iUnit) ## Ramstormp, PTSD, No message because of triangle trade
