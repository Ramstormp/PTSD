...
##mod MRLimit
		...
		### AI units can move start ###
		#if not player.isHuman():
		return False
		### AI units can move end ###
		
		### starting units can move start ###
		if player.getNumCities() < 1: #isFoundedFirstCity()==False:
			return False # MyMRLimit.setRadius(12) #Ramstormp, PTSD, Starting radius
		### starting units can move end ###
		else:
			return MyMRLimit.checkRadius (ePlayer, iUnitId, iPlotX, iPlotY)
##endmod
